...
<li className="flex justify-around text-xl ">
    ...
    <NavLink to="/"> <ul className="mt-3">Home</ul></NavLink>
    <ul className="mt-3">Contact</ul>
    <ul className="mt-3">Support</ul>
    <ul onClick className="mt-3 "><svg xmlns="http://www.w3.org/2000/svg" width="32" height="30" fill="currentColor" class="bi bi-cart " viewBox="0 0 16 16">
